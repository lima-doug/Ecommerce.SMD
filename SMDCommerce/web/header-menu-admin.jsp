...
<%
    if (usuario == null || usuario.getId() == null || usuario.getAdministrador() == false) {
...
<html lang="pt-br">
    ...
    <body style="min-width:372px;">
        <nav class="navbar navbar-expand-lg navbar-dark border-bottom shadow-sm mb-3">
            <div class="container">
                <a class="navbar-brand text-dark" href="adminPrincipal.jsp"><strong>SMD Commerce</strong></a>
                ...
                <div class="navbar-collapse collapse text-dark">
                    <ul class="navbar-nav flex-grow-1">
                        <li class="nav-item me-4">
                            <a href="adminPrincipal.jsp" class="nav-link text-dark">Home</a>
                        </li>
                    </ul>
