 ...
 * @author Douglas Lima
 */
public class CarrinhoCompraPageClienteServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("carrinhosCompraClient.jsp");
